...
function newActionEvent(action, 
...
function filterNamespacedAttributes(attributes) {
    ...
    Object.entries(attributes).forEach(([key, value]) => {
        if (value !== undefined && !isNamespaced(value))
...
function addMissingAttributes(element, newAttributes) {
...
class OscdSave extends s {
    constructor() {
        super();
        window.addEventListener('oscd-edit', event => this.handleEditEvent(event));
    }
    handleComplex(edits) {
        const actions = [];
